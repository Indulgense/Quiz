...
public enum Roman {
    ...
    XLVIII(48), XLIX(49), L(50), LI(51), LII(52), LIII(53), LIV(54),
    LV(55), LVI(56), LVII(57), LVIII(58), LIX(59), LX(60), LXI(61),
    LXII(62), LXIII(63), LXIV(64), LXV(65), LXVI(66), LXVII(67),
    LXVIII(68), LXIX(69), LXX(70), LXXI(71), LXXII(72), LXXIII(73),
    ...
    static public boolean isRoman(String roman) {
        for (Roman rome: Roman.values()){
            if (rome.toString().equals(roman) && rome.ordinal() <10){
                return true;
            }
        }
        return false;
    ...
    static public String getRoman(int arabian) {
        for (Roman rome: Roman.values()){
            if (rome.arabian == arabian) {
                return rome.name();
            }
        }
        return "";
    }
    static public int getArabian(String roman) {
        for (Roman rome: Roman.values()){
            if (rome.name().equals(roman)){
                return rome.getArabian();
            }
        }
        return 0;
    }
